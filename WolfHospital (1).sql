...
--
-- Host: localhost
-- Generation Time: Apr 12, 2019 at 02:48 AM
...
CREATE TABLE `Billing_Account` (
  ...
  `Accomodation_Fee` int(11) NOT NULL,
...
(1, '000011234', '69 ABC St , Raleigh NC 27730', 'Credit card', 4044875409613234, 100, 0, 0),
...
(1, '2019-03-01 05:18:44', '0000-00-00 00:00:00', 1, 1001, 1, 1, 100, 'Nervine', 'Hospitalization'),
(2, '2019-03-10 05:19:22', '0000-00-00 00:00:00', 1, 1002, 2, 1, 100, 'Nervine', 'Hospitalization'),
(3, '2019-03-15 04:19:31', '0000-00-00 00:00:00', 1, 1003, 1, 2, 100, 'Nervine', 'Hospitalization'),
(4, '2019-03-17 04:18:54', '2019-03-21 04:00:00', 0, 1004, 3, 1, 103, 'Analgesic', 'Surgeon, Hospitalization');
...
CREATE TABLE `Patient` (
  ...
  `Treatment_Plan` int(11) NOT NULL,
...
INSERT INTO `Patient` (`Patient_ID`, `SSN`, `Name`, `DOB`, `Gender`, `Phone`, `Street_Address`, `Zipcode`, `Treatment_Plan`, `Status`) VALUES
(1001, '000011234', 'David', '1980-01-30', 'Male', 9191233324, '69 ABC St, Raleigh NC', 27730, 20, 'In Ward'),
(1002, '000021234', 'Sarah', '1971-01-30', 'Female', 9195633478, '81 DEF St, Cary NC', 27519, 20, 'In Ward'),
(1003, '000031234', 'Joseph', '1987-01-30', 'Male', 9199572199, '31 OPG St, Cary NC', 27519, 10, 'In Ward'),
(1004, '000041234', 'Lucy', '1985-01-30', 'Female', 9198387123, '10 TBC St, Raleigh NC', 27730, 5, 'Completing Treatment');
...
--
ALTER TABLE `Medical_Record`
  MODIFY `Record_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1005;
...
--
ALTER TABLE `Treatment`
  ADD CONSTRAINT `treatment_ibfk_1` FOREIGN KEY (`Record_ID`) REFERENCES `Medical_Record` (`Record_ID`);
