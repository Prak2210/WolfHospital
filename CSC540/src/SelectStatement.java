...
//	    	 }
	...
	public static List<Patient> getPatientR()
	{
		Statement stmt = Connection.getInstance();
		String query = "SELECT * FROM Patient";
		ResultSet rs = Connection.getResultset(stmt, query);
	...
	public static List<Staff> getStaffR(Boolean byRoles)
	{
		Statement stmt = Connection.getInstance();
		String query = null;
		if(!byRoles)
	...
	public static List<Ward_Details> getWardDetailsR()
	{
		Statement stmt = Connection.getInstance();
		String query = "SELECT * FROM Ward_Details";
		ResultSet rs = Connection.getResultset(stmt, query);
	...
	public static List<Bed_Details> getBedsR()
	{
		Statement stmt = Connection.getInstance();
		String query = "SELECT * FROM Bed_Details";
		ResultSet rs = Connection.getResultset(stmt, query);
	...
	public static List<Medical_Record> getMedicalRecordsR()
	{
		Statement stmt = Connection.getInstance();
		String query = "SELECT * FROM Medical_Record";
		ResultSet rs = Connection.getResultset(stmt, query);
